    ...
    <section id="zone" className="bg-secondary/50">
      <div className="px-4 py-16">
        ...
        <p className="mx-auto mt-4 max-w-md text-center text-sm text-muted-foreground">
          Un réseau d'artisans partenaires dans sept régions, chacune avec son propre numéro. Sélectionnez la vôtre.
        </p>
          ...
          {ZONES.map((z) => (
            ...
            >
              <div className="min-w-0">
                ...
                <div className="mt-1 text-sm font-semibold tabular-nums text-foreground">{(z.phone ?? NATIONAL_PHONE).display}</div>
              </div>
