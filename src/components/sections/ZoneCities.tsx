          ...
          {zone.departments.map((d) => (
            <div key={d.code}>
              ...
              <p className="mb-4 text-sm text-muted-foreground">
                Artisans partenaires disponibles 24h/24 dans tout le département ({d.code}). Tarif de référence annoncé au téléphone, devis écrit avant intervention.
              </p>
              <div className="space-y-2">
                {d.cities.map((c) => (
                  <Link
                    key={c.slug}
                    to="/$zone/$ville"
                    params={{ zone: zone.slug, ville: c.slug }}
